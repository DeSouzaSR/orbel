...
program el2xv
    ...
    !
    ! Usage:
    !   1) $ el2xv ! prompt ialpha, gm, a, e, inc, capom, omega, capm
    !   2) $ el2xv < input_file ! screen output
    !   3) $ el2xv < input_file > output_file ! output to file
    !
    ! Input:
    !   ialpha  -- conic section type: hyperbole (+1), parabola (0) and
    !   ellipse (-1).
